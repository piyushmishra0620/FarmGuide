  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-screen min-h-screen bg-linear-to-b from-10% from-green-940 via-50% via-green-950 to-100% to-green-960 z-0 cursor-default">
        ...
        <motion.div className="w-screen mt-25 h-fit flex 2sm:flex-row 2sm:gap-[20px] flex-col gap-[8px]" initial={{y:10,opacity:0}} whileInView={{y:0,opacity:1}} viewport={{once:true}} transition={{duration:0.5,ease:"easeInOut"}}>
